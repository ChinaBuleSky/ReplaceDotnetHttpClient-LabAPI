...
public static class HttpExtensions
{
    ...
    {
        FieldInfo? field = typeof(DotnetHttp)
        ...
        FieldInfo? attr = typeof(FieldInfo).GetField("m_fieldAttributes", BindingFlags.NonPublic | BindingFlags.Instance);
        if (attr != null)
        {
            FieldAttributes attrs = (FieldAttributes)attr.GetValue(field)!;
    ...
    {
        HttpClient originalClient = DotnetHttp.CreateClient();
        ...
        field.SetValue(null, originalClient);
    }
